...
const CartScreen = () => {
  ...
  const makePayment = token => {
    ...
    return fetch(`http://localhost:27017/payment`, {
      method: "POST",
      headers: headers,
        ...
        <div className="cartscreen__right">
          ...
          <div>
            <button type="button" onClick={function() {
              ...
              <StripeCheckout stripeKey="pk_test_51KovsoSBP5ESqJdglwHkiOzWNIuaW8OSXLDYapvYrQt4ySFT1QhJTkbA1xjX8svONwimRQfma8GNCIrB1rZ0l6iP002Drl0YM4"
